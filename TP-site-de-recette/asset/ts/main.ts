...
let searchNbrPersonne :string = ""
let resultFilter = document.querySelector('#result-filter') as HTMLDivElement
let nameRecipeSearchInput = document.querySelector('#Name-recipe') as HTMLInputElement
let nbrPersonne = document.querySelector('#nbrPersonne') as HTMLInputElement
